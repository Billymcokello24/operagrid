...
<p align="center">
  <a href="https://operagrid.com">ウェブサイト</a> |
  <a href="#クイックスタート">クイックスタート</a> |
  <a href="https://github.com/Billymcokello24/operagrid/discussions">ディスカッション</a> |
...
OperaGridは、リアルタイムコミュニケーション、プロジェクト管理、生産性ツールを統合した**セルフホスト可能なワークスペースコラボレーションプラットフォーム**です。データを完全に管理したいチーム向けに構築されており、Slack + Notion + Zoom + Asanaの機能を単一のオープンソースアプリケーションで提供します。

ビデオ通話に有料プランが必要なSlackや、リアルタイムチャットがないNotionとは異なり、OperaGridは効果的なコラボレーションに必要なすべてを提供します。チャット、ビデオ通話、プロジェクトボード、ファイル共有、AIアシスタント — ベンダーロックインや独占的ライセンスなし。

<p align="center">
  <img src="frontend/public/dashboard.png" alt="OperaGrid Dashboard" width="800">
  <br>
  <em>統合されたコミュニケーションとプロジェクト管理を備えたOperaGridワークスペースダッシュボード</em>
</p>
...
| 機能 | OperaGrid | Slack | Notion | Asana | Microsoft Teams |
|---------|---------|-------|--------|-------|-----------------|
...
- **単一データモデル上の機能の広さでは**、  
  12の機能領域すべてを1つのリポジトリ、1つのログイン、1つの権限モデルでネイティブに提供しているOSSプロジェクトはOperaGridのみです。Hulyが最も近いですが、forms / approvals / budget / whiteboard 機能は提供していません。この「統合ワークスペース」という価値は単なるマーケティングではなく、実際に意味のあるものです。

- **Pluggable Provider パターン（storage / AI / email / push / search / auth / video を env var レベルで切り替え）では**、  
  これを実現しているのはOperaGridのみです。他のプロジェクトではバックエンドサービスが固定されています。

チャット + ビデオ + ドキュメント + プロジェクト管理 + フォーム + 承認 + 予算管理 + AI を **すべて1つのツールで使いたい場合**、さらにインフラを自由に切り替えたい場合は、OperaGridが現時点で最も明確な選択です。
...
OperaGridは成長するコミュニティを持つ**積極的にメンテナンスされている**プロジェクトです。現在の状況：
...
| メトリック | ステータス | 詳細 |
|--------|--------|---------|
| **総コントリビューター** | ![Contributors](https://img.shields.io/github/contributors/operagrid/operagrid?style=flat-square) | 世界中の開発者による成長するコミュニティ |
| **総コミット** | ![Commits](https://img.shields.io/github/commit-activity/t/operagrid/operagrid?style=flat-square) | 開始以来の積極的な開発 |
| **月次コミット** | ![Commit Activity](https://img.shields.io/github/commit-activity/m/operagrid/operagrid?style=flat-square) | 定期的なアップデートと改善 |
...
OperaGridは以下のカテゴリーにわたる40以上の統合モジュールを搭載：
...
[詳細な機能ドキュメントを見る &rarr;](https://github.com/Billymcokello24/operagrid/wiki)

## プラガブルプロバイダー

すべてのバックエンドサービスは単一の環境変数で差し替え可能です。デフォルト設定ではクラウド認証情報なしでOperaGridを実行できます。準備が整ったらマネージドプロバイダーに切り替えてください。

| ドメイン | 環境変数 | 同梱プロバイダー |
|---|---|---|
| **ストレージ** (PR [#28](https://github.com/Billymcokello24/operagrid/pull/28)) | `STORAGE_PROVIDER` | `local-fs` (デフォルト), `s3`, `r2`, `minio`, `b2`, `gcs`, `azure`, `none` |
| **メール** (PR [#30](https://github.com/Billymcokello24/operagrid/pull/30)) | `EMAIL_PROVIDER` | `smtp`, `resend`, `sendgrid`, `postmark`, `ses`, `mailgun`, `none` |
| **プッシュ** (PR [#31](https://github.com/Billymcokello24/operagrid/pull/31)) | `PUSH_PROVIDER` | `webpush`, `fcm`, `onesignal`, `expo`, `none` |
| **検索** (PR [#32](https://github.com/Billymcokello24/operagrid/pull/32)) | `SEARCH_PROVIDER` | `pg-trgm` (デフォルト、追加インフラ不要), `meilisearch`, `typesense`, `none` |
| **認証 / SSO** (PR [#33](https://github.com/Billymcokello24/operagrid/pull/33)) | `AUTH_PROVIDERS` | `local`, `google`, `github`, `magic-link` (パスワードレス、JWTベース) |
...
OperaGridはreact-i18next経由で複数言語をサポート：
...
OperaGridは単なるオープンソースプロジェクトではありません。モダンな開発実践を習得しながらチームコラボレーションの未来を構築する機会です。
...
**🟢 初心者向け**
- 📝 [タイポの修正またはドキュメントの改善](https://github.com/Billymcokello24/operagrid/labels/documentation)
- 🌍 [翻訳の追加](https://github.com/Billymcokello24/operagrid/labels/i18n) — 英語と日本語をサポート
- 🐛 [シンプルなバグ修正](https://github.com/Billymcokello24/operagrid/labels/good%20first%20issue)
- ✨ [UI/UXの改善](https://github.com/Billymcokello24/operagrid/labels/ui%2Fux)

**🟡 中級者向け**
- 🔗 新しい統合を追加 — [統合ガイド](backend/README.md#integrations)参照
- 🧪 [テストを書く](https://github.com/Billymcokello24/operagrid/labels/tests)
- 🚀 [パフォーマンス改善](https://github.com/Billymcokello24/operagrid/labels/performance)
- 📱 [モバイルレスポンシブネス](https://github.com/Billymcokello24/operagrid/labels/mobile)

**🔴 上級者向け**
- 🤖 [AI機能](https://github.com/Billymcokello24/operagrid/labels/ai) — AutoPilot拡張、新しいAI機能
- ⚙️ [コアエンジン拡張](https://github.com/Billymcokello24/operagrid/labels/core)
- 🏗️ [アーキテクチャ改善](https://github.com/Billymcokello24/operagrid/labels/architecture)
- 🔐 [セキュリティ機能](https://github.com/Billymcokello24/operagrid/labels/security)
...
❓ **質問する** — 詰まったら[GitHubディスカッション](https://github.com/Billymcokello24/operagrid/discussions)を開く
...
- 💡 [GitHubディスカッション](https://github.com/Billymcokello24/operagrid/discussions) — 質問、アイデアを共有
- 📖 [コントリビューションガイド](CONTRIBUTING.md) — 詳細なコントリビューションガイドライン
- 🐛 [GitHubイシュー](https://github.com/Billymcokello24/operagrid/issues) — バグ報告や機能リクエスト
...
**貢献方法：**
- [GitHubイシュー](https://github.com/Billymcokello24/operagrid/issues)でバグ報告や機能リクエスト
- バグ修正や新機能のプルリクエストを提出
- 新しい統合を追加（[統合ガイド](backend/README.md#integrations)参照）
- ドキュメントの改善
- 翻訳の追加
...
OperaGridに貢献してくれたすべての素晴らしい人々に感謝します！🎉
...
開発者とつながり、ヘルプを得て、OperaGridの最新開発について最新情報を入手しましょう！
...
| プラットフォーム | 目的 | リンク |
|----------|---------|------|
| 💡 **GitHubディスカッション** | 質問、アイデア共有、機能リクエスト | [ディスカッションを開始](https://github.com/Billymcokello24/operagrid/discussions) |
| 🐛 **GitHubイシュー** | バグ報告、機能リクエスト | [イシューを開く](https://github.com/Billymcokello24/operagrid/issues) |
| 🌐 **ウェブサイト** | ドキュメント、ガイド、アップデート | [operagrid.com](https://operagrid.com) |
...
<p align="center">
  <a href="https://operagrid.com">ウェブサイト</a> |
  <a href="https://github.com/Billymcokello24/operagrid/wiki">ドキュメント</a> |
  <a href="https://github.com/Billymcokello24/operagrid/discussions">ディスカッション</a>
</p>
...
<p align="center">
  <strong><a href="https://github.com/operagrid">OperaGrid</a>コミュニティによって❤️で構築</strong>
</p>
